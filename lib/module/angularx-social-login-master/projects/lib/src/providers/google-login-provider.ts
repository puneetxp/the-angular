...
export class GoogleLoginProvider extends BaseLoginProvider {
  ...
  private readonly changeUser?: EventEmitter<SocialUser | null> = new EventEmitter<SocialUser | null>();
  private readonly _socialUser: BehaviorSubject<SocialUser | null> = new BehaviorSubject<SocialUser | null>(null);
  ...
  public callback: any;
  public call(callback: (credential: string) => void) {
        ...
        this.loadScript(
          ...
          () => {
            google.accounts.id.initialize({
              ...
              callback: ({ credential }) => {
                this.callback.google(credential)
              },
