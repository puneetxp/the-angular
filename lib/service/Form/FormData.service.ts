// Suggested code may be subject to a license. Learn more: ~LicenseLog:236085183.
...
export class FormDataService {
  ...
  errorCallback: (e: HttpErrorResponse) => void = (e: HttpErrorResponse) => console.log(e);
    ...
    return this.http.request(this.method, this.action, {
        ...
        ...(localStorage.getItem("session_id") !== null ? {
            headers: new HttpHeaders({
                ...this.httpheader?.keys?.length ? this.httpheader : {},
    ...
    Object.keys(json).forEach((key) => key.endsWith("[]")
      ? json[key].forEach((element: any) =>
        this.formData.append(key, 
          (element === undefined || element === null) ? '' : (typeof element == "string") ? element : JSON.stringify(element)))
      :
      this.formData.append(key,
        (json[key] === undefined || json[key] === null) ? '' : (typeof json[key] == "boolean") ?
          String(Number(json[key]))
